...
arquivo_hash = input('Digite o nome do arquivo que contém o o hash md5: ')
...
wordlist = ['123', 'admin', 'senha', 'root', 'teste', 'abc', '123456', 'senha123']
...
for palavra in wordlist:
    ...
    if hash_palavra == hash_alvo:
        print(f'Senha econtrada: {palavra}')
        encontrado = True
        break
